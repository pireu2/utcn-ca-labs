...
HD_PWD='C:/Users/sebi/OneDrive - Technical University of Cluj-Napoca/Documents/Facultate/Anul 2/Semestrul 2/CA - Computer Architecture/utcn-ca-labs/lab_4/lab_4.runs/synth_1'
cd "$HD_PWD"
